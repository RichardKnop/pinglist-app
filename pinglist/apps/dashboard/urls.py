...
from apps.dashboard.views.subscriptions import SubscriptionsView, AddSubscriptionView
...
urlpatterns = [
    ...
    url(r'^subscriptions/add', AddSubscriptionView.as_view(), name='add_subscription'),
